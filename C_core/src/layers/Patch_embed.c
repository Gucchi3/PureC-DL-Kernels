...
Tensor* Patch_embedding(Tensor* input_tensor, W_Tensor* weight_tensor){
  ...
  // -------------------------------------------------------------------------------------------------------------
  // Patch_embedding
  int32_t cal_point_lt = 0; int32_t cal_point_c = 0; int32_t cal_point = 0; 
  int32_t w_point_hwc = 0; int32_t w_point_c = 0; int32_t w_point = 0; 
  float sum = 0;
  int32_t output_index = 0;
  
  for(int32_t h=0; h < input_tensor->H/kernel_size; h++){
    for(int32_t w=0; w < input_tensor->W/kernel_size; w++){
